void PenHor(){
  ...
  float x1 = r1 * sin(a1)*(random(3,5));
  float y1 = r1 * cos(a1)*(random(3,5));

  float x2 = x1 + r2 * sin(a2)*(random(3,5));
  float y2 = y1 + r2 * cos(a2)*(random(3,5));
